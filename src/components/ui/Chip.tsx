...
// The one status/channel pill used across planner + copy builder. Mono uppercase,
// consistent padding/radius. Optional leading dot.
export default function Chip({
  ...
  return (
    <span
      className={`inline-flex items-center gap-1 rounded-sm border px-1.5 py-0.5 font-mono text-[10px] uppercase tracking-wide leading-none ${TONE[tone]} ${className}`}
    >
